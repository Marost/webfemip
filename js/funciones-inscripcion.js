...
jefform(document).ready(function(){
	jefform(".fc_enviar").click(function() {
		...
		var asoc_nombre = jefform("#fc_asoc_nombre").val();
			...
			asoc_zip = jefform("#fc_asoc_zip").val();
			asoc_direccion = jefform("#fc_asoc_direccion").val();
			asoc_telcasa = jefform("#fc_asoc_telcasa").val();
			asoc_email = jefform("#fc_asoc_email").val();
			asoc_teloficina = jefform("#fc_asoc_teloficina").val();
			asoc_num = jefform("#fc_asoc_num").val();
			rep_cargo = jefform("#fc_rep_cargo").val();
			rep_nombre = jefform("#fc_rep_nombre").val();
			rep_direccion = jefform("#fc_rep_direccion").val();
			rep_telcasa = jefform("#fc_rep_telcasa").val();
			rep_email = jefform("#fc_rep_email").val();
			rep_teloficina = jefform("#fc_rep_teloficina").val();
			rep_telcelular = jefform("#fc_rep_telcelular").val();			
