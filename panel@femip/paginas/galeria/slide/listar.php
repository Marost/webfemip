    ...
    <div id="contenido_total">
        ...
        <div id="contenido">
              ...
              <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td width="71%" ><p><a href="../../../paginas/galeria/slide/form-agregar.php?noticia=<?php echo $idnoticia; ?>">
...
<ul id="test-list">
	<?php while($fila_galeria=mysql_fetch_array($rst_galeria)){ ?>
        <li id="listItem_<?php echo $fila_galeria["id"] ?>" class="alto">
            ...
            <a href="../../../paginas/galeria/slide/form-modificar.php?id=<?php echo $fila_galeria["id"] ?>&amp;noticia=<?php echo $idnoticia ?>">
